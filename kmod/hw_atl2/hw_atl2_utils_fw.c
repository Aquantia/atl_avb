...
int hw_atl2_utils_get_filter_caps(struct aq_hw_s *self)
{
	...
	if (priv->art_count == 0 || priv->art_count > HW_ATL2_RPF_INDEX_NUMBER)
		priv->art_count = HW_ATL2_RPF_INDEX_NUMBER;
	...
	priv->flex_filter_available = filter_caps.flexible_filter_mask;
	return 0;
}
