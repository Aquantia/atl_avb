...
{
	aq_hw_write_reg_bit(aq_hw, HW_ATL_RPF_FLEX_ENH_ADR(filter),
			HW_ATL_RPF_FLEX_ENH_MSK,
			HW_ATL_RPF_FLEX_ENH_SHIFT, val);
}

void hw_atl_rpf_flex_rxqen_set(struct aq_hw_s *aq_hw, u32 val, u32 filter)
{
	aq_hw_write_reg_bit(aq_hw, HW_ATL_RPF_FLEX_RXEN_ADR(filter),
			HW_ATL_RPF_FLEX_RXEN_MSK,
			HW_ATL_RPF_FLEX_RXEN_SHIFT, val);
}

void hw_atl_rpf_flex_tag_set(struct aq_hw_s *aq_hw, u32 val, u32 filter)
{
	aq_hw_write_reg_bit(aq_hw, HW_ATL_RPF_FLEX_TAG_ADR(filter),
			HW_ATL_RPF_FLEX_TAG_MSK,
			HW_ATL_RPF_FLEX_TAG_SHIFT, val);
}

void hw_atl_rpf_flex_rxqf_set(struct aq_hw_s *aq_hw, u32 val, u32 filter)
{
	aq_hw_write_reg_bit(aq_hw, HW_ATL_RPF_FLEX_RXQH_ADR(filter),
			HW_ATL_RPF_FLEX_RXQH_MSK,
			HW_ATL_RPF_FLEX_RXQH_SHIFT, val);
}

void hw_atl_rpf_flex_mngrxq_set(struct aq_hw_s *aq_hw, u32 val, u32 filter)
{
	aq_hw_write_reg_bit(aq_hw, HW_ATL_RPF_FLEX_MNGRXQH_ADR(filter),
			HW_ATL_RPF_FLEX_MNGRXQH_MSK,
			HW_ATL_RPF_FLEX_MNGRXQH_SHIFT, val);
}

void hw_atl_rpf_flex_act_set(struct aq_hw_s *aq_hw, u32 val, u32 filter)
{
	aq_hw_write_reg_bit(aq_hw, HW_ATL_RPF_FLEX_ACTH_ADR(filter),
			HW_ATL_RPF_FLEX_ACTH_MSK,
			HW_ATL_RPF_FLEX_ACTH_SHIFT, val);
}

void hw_atl_rpf_flex_byte_a_loc_set(struct aq_hw_s *aq_hw, u32 val, u32 filter)
{
	aq_hw_write_reg_bit(aq_hw, HW_ATL_RPF_FLEX_BYTEALOCH_ADR(filter),
			HW_ATL_RPF_FLEX_BYTEALOCH_MSK,
			HW_ATL_RPF_FLEX_BYTEALOCH_SHIFT, val);
}

void hw_atl_rpf_flex_byte_b_loc_set(struct aq_hw_s *aq_hw, u32 val, u32 filter)
{
	aq_hw_write_reg_bit(aq_hw, HW_ATL_RPF_FLEX_BYTEBLOCH_ADR(filter),
			HW_ATL_RPF_FLEX_BYTEBLOCH_MSK,
			HW_ATL_RPF_FLEX_BYTEBLOCH_SHIFT, val);
}

void hw_atl_rpf_flex_byte_a_msk_set(struct aq_hw_s *aq_hw, u32 val, u32 filter)
{
	aq_hw_write_reg_bit(aq_hw, HW_ATL_RPF_FLEX_BYTEAMSKH_ADR(filter),
			HW_ATL_RPF_FLEX_BYTEAMSKH_MSK,
			HW_ATL_RPF_FLEX_BYTEAMSKH_SHIFT, val);
}
void hw_atl_rpf_flex_byte_b_msk_set(struct aq_hw_s *aq_hw, u32 val, u32 filter)
{
	aq_hw_write_reg_bit(aq_hw, HW_ATL_RPF_FLEX_BYTEBMSKH_ADR(filter),
			HW_ATL_RPF_FLEX_BYTEBMSKH_MSK,
			HW_ATL_RPF_FLEX_BYTEBMSKH_SHIFT, val);
}

void hw_atl_rpf_flex_byte_a_pat_set(struct aq_hw_s *aq_hw, u32 val, u32 filter)
{
	aq_hw_write_reg_bit(aq_hw, HW_ATL_RPF_FLEX_BYTEAPATH_ADR(filter),
			HW_ATL_RPF_FLEX_BYTEAPATH_MSK,
			HW_ATL_RPF_FLEX_BYTEAPATH_SHIFT, val);
}

void hw_atl_rpf_flex_byte_b_pat_set(struct aq_hw_s *aq_hw, u32 val, u32 filter)
{
	aq_hw_write_reg_bit(aq_hw, HW_ATL_RPF_FLEX_BYTEBPATH_ADR(filter),
			HW_ATL_RPF_FLEX_BYTEBPATH_MSK,
			HW_ATL_RPF_FLEX_BYTEBPATH_SHIFT, val);
}

void hw_atl_rpf_flex_mask_word_set(struct aq_hw_s *aq_hw, u32 val, u32 filter, u32 word)
{
	aq_hw_write_reg(aq_hw, HW_ATL_RPF_FLEX_BYTEMSKHWORDW_ADR(filter) + word * 4, val);
}

void hw_atl_rpf_flex_bytepat_sel_set(struct aq_hw_s *aq_hw, u32 val)
{
	aq_hw_write_reg_bit(aq_hw, HW_ATL_RPF_FLEX_BYTEPATSEL_ADR,
			HW_ATL_RPF_FLEX_BYTEPATSEL_MSK,
			HW_ATL_RPF_FLEX_BYTEPATSEL_SHIFT, val);
}

void hw_atl_rpf_flex_bytepat_wr_en_set(struct aq_hw_s *aq_hw, u32 val)
{
	aq_hw_write_reg_bit(aq_hw, HW_ATL_RPF_FLEX_BYTEPATWRENI_ADR,
			HW_ATL_RPF_FLEX_BYTEPATWRENI_MSK,
			HW_ATL_RPF_FLEX_BYTEPATWRENI_SHIFT, val);
}

void hw_atl_rpf_flex_bytepat_addr_set(struct aq_hw_s *aq_hw, u32 val)
{
	aq_hw_write_reg_bit(aq_hw, HW_ATL_RPF_FLEX_BYTEPATADDR_ADR,
			HW_ATL_RPF_FLEX_BYTEPATADDR_MSK,
			HW_ATL_RPF_FLEX_BYTEPATADDR_SHIFT, val);
}

void hw_atl_rpf_flex_bytepat_data_set(struct aq_hw_s *aq_hw, u32 val)
{
	aq_hw_write_reg(aq_hw, HW_ATL_RPF_FLEX_BYTEPATWRDATA_ADR, val);
}

void hw_atl_rpf_flex_byte_mask_len_set(struct aq_hw_s *aq_hw, u32 val)
{
	aq_hw_write_reg_bit(aq_hw, HW_ATL_RPF_FLEX_FILTERLEN_ADR,
			HW_ATL_RPF_FLEX_FILTERLEN_MSK,
			HW_ATL_RPF_FLEX_FILTERLEN_SHIFT, val);
}
...
{
	aq_hw_write_reg(aq_hw, HW_ATL_GLB_CPU_SCRPAD2_SCP_ADR(scratch_scp),
			glb_cpu_scratch_scp);
}
