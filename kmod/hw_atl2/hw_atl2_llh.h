...
void hw_atl2_correct_launchtime(struct aq_hw_s *aq_hw, unsigned int mbps,
				unsigned int offset);
...
/** \brief Set TSG EXT CLK TS Input select
*   \param tsgExtClkTsInputSelect 
*   \note Default value: 0x0
*   \note PORT="pif_tsg_ext_clk_ts_sel_i[4:0]"
*/
//void hw_atl2_tsg1_ext_clk_ts_input_select_set(struct aq_hw_s *aq_hw, uint32_t tsgExtClkTsInputSelect);
