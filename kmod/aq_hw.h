...
#define AQ_RX_FIRST_LOC_FLEX	   32U
#define AQ_RX_LAST_LOC_FLEX	       33U
#define AQ_RX_FIRST_LOC_FL3L4	   38U
#define AQ_RX_LAST_LOC_FL3L4	   45U
#define AQ_RX_FIRST_LOC_FIPV4	   46U
#define AQ_RX_LAST_LOC_FIPV4	   53U
#define AQ_RX_FIRST_LOC_FIPV6	   54U
#define AQ_RX_LAST_LOC_FIPV6	   61U
#define AQ_RX_FIRST_LOC_L2DST	   62U
#define AQ_RX_LAST_LOC_L2DST	   69U
#define AQ_RX_MAX_RXNFC_LOC	       AQ_RX_LAST_LOC_L2DST
#define AQ_RX_FIRST_LOC_CHAIN	   80U
#define AQ_RX_LAST_LOC_CHAIN       95U
...
#define AQ_RX_FILTER_CHAIN_MASK 0xFFU
#define AQ_RX_FILTER_CHAIN_VLAN_LOC_SHIFT 8U
#define AQ_RX_FILTER_CHAIN_VLAN_LOC_MASK 0x00000F00U
#define AQ_RX_FILTER_CHAIN_L2ET_LOC_SHIFT 12U
#define AQ_RX_FILTER_CHAIN_L2ET_LOC_MASK 0x0000F000U
#define AQ_RX_FILTER_CHAIN_L3L4_LOC_SHIFT 16U
#define AQ_RX_FILTER_CHAIN_L3L4_LOC_MASK 0x00070000U
#define AQ_RX_FILTER_CHAIN_FLEX_LOC_SHIFT 19U
#define AQ_RX_FILTER_CHAIN_FLEX_LOC_MASK 0x00080000U
#define AQ_RX_FILTER_CHAIN_L3_LOC_SHIFT 20U
#define AQ_RX_FILTER_CHAIN_L3_LOC_MASK 0x00700000U
#define AQ_RX_FILTER_CHAIN_L2_DST_SHIFT 23U
#define AQ_RX_FILTER_CHAIN_L2_DST_MASK 0x1f800000U
#define AQ_RX_FILTER_CHAIN_CURRENT_MASK 0x80000000U
...
struct aq_hw_ops {
	...
	int (*hw_filter_l3_set)(struct aq_hw_s *self,
	...
	int (*hw_filter_flex_set)(struct aq_hw_s *self,
				  struct aq_rx_filter_flex *data);

	int (*hw_filter_chain_build)(struct aq_hw_s *self,
				  struct aq_rx_filter *data, bool add);
	...
	int (*hw_gpio_pulse)(struct aq_hw_s *self, u32 index, u32 clk_sel, u64 start,
			     u32 period, u32 hightime);

	int (*hw_ext_interrupr_en)(struct aq_hw_s *self, int on, u32 flags);

	int (*hw_extts_gpio_enable)(struct aq_hw_s *self, u32 index, u32 channel, int on);

	u64 (*hw_ptp_gpio_get_event)(struct aq_hw_s *aq_hw, u32 channel, u32 *event_count);
	...
	void (*apply_link_speed)(struct aq_hw_s *self, unsigned int mbps);
...
#ifdef PTM_SUPPORT
	int (*hw_ptm_enable)(struct aq_hw_s *self, u32 timeout, uint32_t endianess_fix);
	int (*hw_ptm_get_info)(struct aq_hw_s *self, struct ptm_data *info);
#endif
#ifdef TSN_SUPPORT
	int (*hw_tsn_enable)(struct aq_hw_s *self, int enable);
#endif
};
...
struct aq_fw_ops {
...
#ifdef TSN_SUPPORT
	void (*enable_tsn)(struct aq_hw_s *self, int enable);
#endif
	...
	int (*restart_aneg)(struct aq_hw_s *self);
};
